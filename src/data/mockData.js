...
// Each ticket has a number (WR-####). Status pipeline (no promised dates):
// Received → In progress → Waiting on parts → Contact for pickup → Completed.
// pill: green=ready, gold=active/parts, gray=received/completed
export const initialRepairs = [
  {
    ...
    customer: 'D. Hayes',
    detail: 'Crystal replaced · ready for pickup',
    status: 'Contact for pickup',
    pill: 'green',
    cost: '$385',
  },
  {
    ...
    customer: 'M. Chen',
    detail: 'Awaiting parts on order',
  ...
  },
  {
    ...
    watch: 'Cartier Tank',
    customer: 'L. Ortiz',
    detail: 'Battery + service under way',
    status: 'In progress',
    pill: 'gold',
    cost: '$140',
  },
  {
    ...
    customer: 'A. Rao',
    detail: 'Logged · awaiting diagnosis',
    status: 'Received',
    pill: 'gray',
    cost: '—',
  },
  {
    ...
    watch: 'Seiko Prospex',
    customer: 'K. Liu',
    detail: 'Movement service under way',
    status: 'In progress',
    pill: 'gold',
    cost: '$95',
  },
  {
    ...
    customer: 'R. Diaz',
    detail: 'Serviced · ready for pickup',
    status: 'Contact for pickup',
    pill: 'green',
    cost: '$120',
  },
